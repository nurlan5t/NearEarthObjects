...
class NearEarthObject:
    ...
    # Construct arguments should accept
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname} has a diameter of {self.diameter:.3f} km and is potentially hazardous = {self.hazardous}"
...
class CloseApproach:
    ...
    # TODO: How can you, and should you, change the arguments to this constructor?
    # If you make changes, be sure to update the comments in this file.
    def __init__(self, time, distance=float('nan'), velocity=float('nan'), neo=None, _designation=None):
        ...
        self._designation = str(neo.designation) if neo else ''
